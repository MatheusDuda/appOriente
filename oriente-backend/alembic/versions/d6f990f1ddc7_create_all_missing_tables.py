...
Revision ID: d6f990f1ddc7
Revises: 
Create Date: 2025-11-21 08:32:06.138403
...
def upgrade() -> None:
    ...
    user_status_enum = ENUM('ACTIVE', 'INACTIVE', name='userstatus', create_type=False)
    user_status_enum.create(op.get_bind(), checkfirst=True)

    user_role_enum = ENUM('ADMIN', 'USER', 'MANAGER', name='userrole', create_type=False)
    user_role_enum.create(op.get_bind(), checkfirst=True)

    op.create_table('chats',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('type', sa.Enum('INDIVIDUAL', 'GROUP', name='chattype'), nullable=False),
    ...
    op.create_table('comment_audits',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    sa.ForeignKeyConstraint(['original_author_id'], ['users.id'], ondelete='SET NULL'),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_comment_audits_id'), 'comment_audits', ['id'], unique=False)
    op.create_table('notifications',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('type', sa.Enum('TASK', 'TEAM', 'SYSTEM', name='notificationtype'), nullable=False),
    sa.Column('title', sa.String(length=255), nullable=False),
    sa.Column('message', sa.Text(), nullable=False),
    sa.Column('is_read', sa.Boolean(), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('recipient_user_id', sa.Integer(), nullable=False),
    sa.Column('related_entity_type', sa.Enum('TASK', 'PROJECT', 'TEAM', name='relatedentitytype'), nullable=True),
    ...
    sa.Column('status', sa.Enum('ACTIVE', 'INACTIVE', name='teamstatus'), nullable=False),
    ...
    sa.Column('status', sa.Enum('ACTIVE', 'ARCHIVED', 'DELETED', name='cardstatus'), nullable=False),
    ...
    op.create_table('card_histories',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('action', sa.Enum('CREATED', 'UPDATED', 'MOVED', 'COMMENT_ADDED', 'COMMENT_DELETED', 'ASSIGNEE_ADDED', 'ASSIGNEE_REMOVED', 'TAG_ADDED', 'TAG_REMOVED', name='cardhistoryaction'), nullable=False),
    sa.Column('card_id', sa.Integer(), nullable=False),
    sa.Column('project_id', sa.Integer(), nullable=False),
    ...
    op.create_index(op.f('ix_card_histories_id'), 'card_histories', ['id'], unique=False)
...
def downgrade() -> None:
    ...
    op.alter_column('users', 'role',
               existing_type=sa.Enum('ADMIN', 'USER', 'MANAGER', name='userrole'),
    ...
    op.drop_index(op.f('ix_card_histories_id'), table_name='card_histories')
    op.drop_table('card_histories')
    ...
    op.drop_index(op.f('ix_comment_audits_id'), table_name='comment_audits')
    op.drop_table('comment_audits')
